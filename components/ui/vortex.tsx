...
export const Vortex: React.FC<VortexProps> = (props) => {
  ...
  let tick = 0;
  // simplex-noise: pass an RNG (Math.random) to satisfy TS signature
  const noise3D = createNoise3D(Math.random);

  // particle props stored in Float32Array for performance
  ...
  const initParticle = (i: number) => {
    ...
    // order: x, y, vx, vy, life, ttl, speed, radius, hue
  ...
  // setup and resize are stable; useCallback ensures stable identity for effect deps
